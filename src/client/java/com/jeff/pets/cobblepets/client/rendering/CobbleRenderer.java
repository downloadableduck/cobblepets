...
public abstract class CobbleRenderer<T extends Entity & GeoAnimatable, U extends LivingEntityRenderState> extends GeoEntityRenderer<T, U> {
    public CobbleRenderer(EntityRendererProvider.Context context, GeoModel<@NotNull T> model) {
        super(context, model);
    }

    @Override
    public void extractRenderState(T entity, U state, float f) {
